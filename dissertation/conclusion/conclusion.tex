...
In the section before, result proved the feasibility of such an algorithm by combining object proposal method with fast Region Convolutional Neural Network.
...
However, hypothesis can be made that if we train the object proposal method under the specialised ear dataset, it can achieve rather good detection rate compare to the current work we have done.
%===========================================================
