...
\fig{screenshot_1}{The screenshot after finish traing on the fast R-CNN with BING object proposal method}{0.9}

\fig{screenshot_2}{The screenshot when applying our algorithm on the SOTON ear database for testing}{0.9}
\end{appendices}
