...
They trained several strong classifiers with AdaBoost algorithm and then cascaded them together into a multi-layer classifier. As all the sub-windows of the image pass through all the classifier, 
